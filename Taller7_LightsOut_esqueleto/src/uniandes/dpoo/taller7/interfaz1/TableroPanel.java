...
public class TableroPanel extends JPanel {
    ...
    public TableroPanel() {
        ...
        this.tablero = new Tablero(5); // Ejemplo con tablero de 5x5
        inicializarTablero();
    ...
    private void inicializarTablero() {
        // Inicializa el tablero con alguna configuración
        tablero.desordenar(10); // Desordenar con una dificultad de 10
    }
